...
- 上下文 Token 占用拆分展示，直观查看 Token 用量
- 斜杠命令系统：输入或点击 `/` 按钮唤起命令菜单（帮助、压缩、重试、停止、新建、统计、思考强度、思考显示等命令）
...
- Token 用量实时监控
- 思考强度（Reasoning Effort）档位设置，针对不同模型精细调节推理强度
